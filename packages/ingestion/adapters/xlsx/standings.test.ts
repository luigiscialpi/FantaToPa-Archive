...
// Percorso del file reale usato per progettare l'adapter (sezione 2 del piano).
// In CI questo fixture andrà copiato in packages/ingestion/__fixtures__/ —
// qui punta ancora al file originale per il test di Fase 0.
const REAL_FILE =
